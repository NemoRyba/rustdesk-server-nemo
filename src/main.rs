...
fn main() -> ResultType<()> {
    ...
    let args = format!(
        ...
        , --nemo-api-tls=[MODE] 'Nemo API TLS: auto (self-signed) | off. Default ON for any routable bind -- `off` needs --nemo-api-allow-insecure Y and puts the admin token in the clear.'
